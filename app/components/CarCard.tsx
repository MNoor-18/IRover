...
const CarCard = ({car, srcOfImage}: CarCardProps) => {
    ...
    return (
      <div className="group w-52 lg:w-64 xl:w-xs rounded-xl sm:rounded-3xl bg-white shadow-md sm:shadow-lg p-3 md:p-5 xl:p-8 flex flex-col justify-center items-start text-black hover:shadow-xl ">
