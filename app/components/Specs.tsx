...
const Specs = () => (
    ...
    <div className="h-full w-full sm:p-5 mt-5 flex flex-col gap-5 xl:flex-row justify-between items-center">
        ...
        {/* Images Container */}
        <div className="w-full h-68 sm:h-84 lg:h-90 xl:h-116 max-xl:order-first lg:w-xl 2xl:w-3xl bg-white overflow-hidden backdrop-blur-lg shadow-xl border-white border-2 sm:border-4 rounded-lg sm:rounded-xl flex gap-1 *:rounded-lg">
            {/* container 1 */}
