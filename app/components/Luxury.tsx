...
const Luxury = () => (
    ...
    <div className="h-full w-full sm:p-5 mt-5 flex flex-col gap-5 xl:flex-row justify-between items-center">
        ...
        {/* Images Container */}
        <div className="w-full h-68 sm:h-84 lg:h-90 xl:h-116 max-xl:order-first lg:w-xl 2xl:w-3xl bg-white overflow-hidden backdrop-blur-lg shadow-xl border-white border-2 sm:border-4 gap-0.5 sm:gap-1 rounded-lg sm:rounded-xl flex flex-col *:rounded-lg">
            {/* container 1 */}
            <div className="h-1/2 w-full flex gap-0.5 sm:gap-1 *:overflow-hidden *:relative">
                {/* num 1 */}
                <div className="h-full w-8/12 rounded-lg sm:rounded-xl">
                ...
                {/* num 2 */}
                <div className="h-full w-4/12 rounded-lg sm:rounded-xl">
            ...
            {/* container 2 */}
            <div className="w-full h-1/3 flex gap-0.5 sm:gap-1 *:overflow-hidden *:relative">
                {/* num 3 */}
            ...
            {/* container 3 */}
            <div className="h-1/3 w-full flex gap-0.5 sm:gap-1 *:overflow-hidden *:relative">
                {/* num 5 */}
                <div className="w-1/2 h-full rounded-lg sm:rounded-xl">
